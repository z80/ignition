...
template <>
TerrainHeightFractal<TerrainHeightAsteroid4>::TerrainHeightFractal(const PiSourceDesc&body) :
	PiBodySource(body)
{
...
template <>
Float TerrainHeightFractal<TerrainHeightAsteroid4>::GetHeight(const Vector3d &p) const
{
	const Float n = octavenoise(6, 0.2 * octavenoise(GetFracDef(0), 0.3, p), 2.8 * ridged_octavenoise(GetFracDef(1), 0.5, p), p) *
