...
static const Float EARTH_RADIUS = 6378135.0; // m
static const Float EARTH_MASS = 5.9742e24; // Kg
static const Float SOL_RADIUS = 6.955e8; // m
static const Float SOL_MASS = 1.98892e30; // Kg

static const Float AU = 149598000000.0; // m
