...
template <>
TerrainHeightFractal<TerrainHeightBarrenRock3>::TerrainHeightFractal(const PiSourceDesc&body) :
	PiBodySource(body)
{
}

template <>
Float TerrainHeightFractal<TerrainHeightBarrenRock3>::GetHeight(const Vector3d &p) const
{
