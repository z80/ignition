...
template <>
TerrainHeightFractal<TerrainHeightWaterSolid>::TerrainHeightFractal(const PiSourceDesc&body) :
	PiBodySource(body)
{
...
template <>
Float TerrainHeightFractal<TerrainHeightWaterSolid>::GetHeight(const Vector3d &p) const
{
