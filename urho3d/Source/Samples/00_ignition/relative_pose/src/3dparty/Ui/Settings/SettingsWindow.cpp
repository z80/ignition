...
void SettingsWindow::Create()
{
    ...
    SubscribeToEvent(buttonClose, E_RELEASED, [&](StringHash eventType, VariantMap& eventData) {
        ...
        SendEvent(IgnEvents::E_CLOSE_WINDOW, data);
    });
...
{
    SubscribeToEvent(IgnEvents::E_INPUT_MAPPING_FINISHED, URHO3D_HANDLER(SettingsWindow, HandleControlsUpdated));
    SubscribeToEvent(IgnEvents::E_STOP_INPUT_MAPPING, URHO3D_HANDLER(SettingsWindow, HandleControlsUpdated));
}
...
*/
    ...
    gammaSlider->SetRange(Ign::GAMMA_MAX_VALUE);
...
void SettingsWindow::CreateGameTab()
{
    ...
    SubscribeToEvent(languageMenu, E_ITEMSELECTED, [&](StringHash eventType, VariantMap &eventData) {
        ...
        SendEvent(IgnEvents::E_OPEN_WINDOW, data);
    });
...
void SettingsWindow::SaveVideoSettings()
{
    ...
    SendEvent(IgnEvents::E_VIDEO_SETTINGS_CHANGED);
}
