...
## Exported variables
var flare_strength := 1.0: set = set_flare_strength
var flare_bias := 1.05: set = set_flare_bias
var flare_blur := 2.0: set = set_flare_blur

var distortion_quality := 0: set = set_distortion_quality
var distortion := 2.0: set = set_flare_distortion

var ghost_count := 7: set = set_ghost_count
var ghost_spacing := 0.3: set = set_ghost_spacing
var halo_width := 0.25: set = set_halo_width

var streak_strength := 0.5: set = set_streak_strength
var lens_dirt = preload("lens_dirt_default.jpeg"): set = set_lens_dirt
## Exported variables
