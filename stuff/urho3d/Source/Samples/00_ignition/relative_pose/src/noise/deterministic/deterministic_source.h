...
#ifndef __DETERMINISTIC_SOURCE_H_
#define __DETERMINISTIC_SOURCE_H_
...
class DeterministicSource: public HeightSource
{
public:
    DeterministicSource( const PiSourceDesc & body );
    ~DeterministicSource();

    virtual Float height( const Vector3d & at ) const override;
    virtual Color color( const Vector3d & at, const Vector3d & norm, Float height )  const override;
