...
template <>
TerrainColorFractal<TerrainColorRock2>::TerrainColorFractal(const PiSourceDesc&body) :
	PiBodySource(body)
{
}

template <>
Vector3d TerrainColorFractal<TerrainColorRock2>::GetColor(const Vector3d &p, Float height, const Vector3d &norm) const
{
	...
	Float equatorial_desert = (2.0 - m_icyness) * (-1.0 + 2.0 * octavenoise(4, 0.05, 2.0, (n * 2.0) * p)) *
