...
func regenerate_mesh():
	...
	var se3: Se3Ref = Se3Ref.new()
	se3.r = Vector3( 5.0, 0.0, 0.0 )
	
	var source_se3: Se3Ref = se3.inverse()
	...
	_voxels.precompute_scaled_values( source_se3, 0, 1.0 )
	var mesh_inst: MeshInstance = get_node( "Mesh" )
	_voxels.apply_to_mesh_only_wireframe( mesh_inst )
	mesh_inst.global_transform = se3.transform
