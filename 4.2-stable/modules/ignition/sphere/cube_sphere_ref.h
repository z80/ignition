...
class CubeSphereRef: public RefCounted
{
    GDCLASS(CubeSphereRef, RefCounted);
...
public:
    ...
    void locate_mesh( Node * sphere_ref_frame, Node * ref_frame, Ref<RefCounted> subdivide_source_ref, Node * mesh_instance_node );
    void generate_mesh( Node * sphere_ref_frame, Node * ref_frame, Ref<RefCounted> subdivide_source_ref, Node * mesh_instance_node );

    const Array & collision_triangles( Node * sphere_ref_frame, Node * ref_frame, Ref<RefCounted> subdivide_source_ref );
