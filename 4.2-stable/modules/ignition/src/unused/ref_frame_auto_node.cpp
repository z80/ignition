...
void RefFrameAutoNode::_bind_methods()
{
	...
	ClassDB::bind_method( D_METHOD( "get_distance_scaler"), &RefFrameAutoNode::get_distance_scaler );

	ClassDB::bind_method( D_METHOD( "set_root_path", "path"), &RefFrameAutoNode::set_root_path );
	ClassDB::bind_method( D_METHOD( "get_root_path"), &RefFrameAutoNode::get_root_path );

	ClassDB::bind_method( D_METHOD( "distance_scaled_t"), &RefFrameAutoNode::distance_scaled_t );
	ClassDB::bind_method( D_METHOD( "distance_scale" ), &RefFrameAutoNode::distance_scale );
}
...
Transform3D RefFrameAutoNode::distance_scaled_t() const
{
	Transform3D t = se3_root_.transform();
